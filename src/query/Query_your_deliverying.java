...
/**
 * Servlet implementation class Query_your_deliverying
 */
public class Query_your_deliverying extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Query_your_deliverying() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		// 数据查询		
		List<Deliveryer> row = Test2.query_by_deliveryer_id(deliveryer_id);
		// List -> JSONArray
