...
/**
 * Servlet implementation class Deliveryed
 */
public class Deliveryed extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		// 数据查询		
		List<Deliveryer> row = Test2.query_deliveryed(deliveryer_id);
		// List -> JSONArray
		JSONArray result = new JSONArray(row);
		for(Object s:result)
		{
			System.out.println("query_delivered");
